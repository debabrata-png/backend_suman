const Pat=require('./../Models/meeting');
...
exports.getaddmeeting= (req,res) => {
    ...
    if(user1) {
        res.status(200).render('addmeeting', {
            title: 'Add meeting'
        });
...
exports.getviewmeeting= async (req,res) => {
    //res.cookie("user","Akshata");
...
exports.geteditmeeting= async (req,res) => {
    ...
    try{
        ...
        if(user1) {
            ...
            res.status(200).render('editmeeting', {
                pub: leditcat,
                title: 'Edit'
