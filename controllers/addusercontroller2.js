...
exports.createusers2 = async (req, res) => {
...
exports.createusersadmin2 = async (req, res) => {
...
exports.getcat12 = async (req, res) => {
...
exports.getallusersapi2 = async (req, res) => {
    try {
        ...
        res.status(200).json({
            ...
            data: users // StoreUserAccessds2 expects { data: [...] } if using response.data.data
        });
    } catch (err) {
        res.status(400).json({
            status: 'fail',
