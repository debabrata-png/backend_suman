...
exports.getinvoicebyfac= async (req,res) => {
    //res.cookie("user","Akshata");
    ...
    try{
        ...
        const user1=req.query.user;
        const colid=req.query.colid;
        const lcat1233= await Invoice.find()
        .where('user')
        .equals(user1);
...
exports.createinvoicebyfac= async (req,res) => {
    ...
    try{
        ...
        const pub1= await Invoice.create({ 
            name: req.query.name,
            colid: req.query.colid,
            user: req.query.user,
            ...
            createdon: new Date(req.query.createdon),
            clientgst: req.query.clientgst,
            clientaddress: req.query.address,
            receiveddate: new Date(req.query.receiveddate),
            bank: req.query.bank,
...
exports.updateinvoicebyfac= async (req,res) => {
    ...
    try{
        ...
        const lcat1= await Invoice.findByIdAndUpdate( req.query.id,{
            name: req.query.name,
            colid: req.query.colid,
            user: req.query.user,
            client: req.query.client,
...
exports.deleteinvoicebyfac= async (req,res) => {
