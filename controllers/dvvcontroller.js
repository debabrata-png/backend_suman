...
exports.projectyrdocsa= async (req,res) => {
  try{
            ...
            .aggregate([
                { $addFields: { 'userId': { $toString: '$_id' }}},
                {
                  ...
                  }, 
                  {
                    $match: {
                      'colid': parseInt(req.query.colid),
                      'yearofrevision': req.query.year.toString()
                    }
                  }
                  ]);
...
exports.seminardocsa= async (req,res) => {
  try{
...
exports.projectdoccommentsa= async (req,res) => {
  try{
...
exports.seminardoccommentsa= async (req,res) => {
  try{
...
exports.admissiondoccommentsa= async (req,res) => {
  try{
          ...
          .aggregate([
              { $addFields: { 'userId': { $toString: '$_id' }}},
              {
                ...
                },
                {
                  $match: {
                    'colid': parseInt(req.query.colid),
                    'academicyear': req.query.year.toString()
                  }
                }
                ]);
...
exports.eventdoccommentsa= async (req,res) => {
  try{
...
exports.passdoccommentsa= async (req,res) => {
  try{
